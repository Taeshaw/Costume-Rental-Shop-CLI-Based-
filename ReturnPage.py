...
def valid_id_here():
    ...
    while  valid_data == False:
        ...
        while True:
            try:
                ID = int(input("\n Enter The Costume ID You Desire To Return --------> "))
                break
            except:
                print("")
...
def valid_quantity_here(ID):
    ...
    if 0 < quantity_1:
        ...
        print("")
        ask = input("Want To Return Any Other Coustumes? (yes/no)").lower()
        print("")
        if ask == "yes":
            returnvaluestomain()
        else:
...
def invoice():
    ...
    print("\tDate of Return: ",datecurrent)
    print("-"*70)
    ...
    returnline = "<<<<<<--------Return Bill--------------->>>>>>"
    productline = "<<<<<-------Product Details------------->>>>>>"
    justdash = "-----------------------------------------------"
    filevarrandom = random.randint(1,100)
    filevar1 = name+str(filevarrandom)+".txt"
    
    billinvoice.append(returnline)
    billinvoice.append("Customer Name: "+name)
    billinvoice.append("Customer Mobile Number: "+phone)
    billinvoice.append("Date Of Return: "+datecurrent)
